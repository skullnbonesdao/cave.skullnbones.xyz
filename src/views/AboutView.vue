<template>
  <div class="flex flex-col w-full mt-3">
    ...
    <div
      class="justify-center p-5 mx-12 bg-base-300 rounded-box place-items-center"
    >
      <div class="flex flex-col mx-6">
        ...
        <div class="artboard text-center rounded-md p-6 space-y-2">
          ...
          <h2 class="text-xl">Interpretation</h2>
          <p>
          ...
          <h1 class="text-2xl">External Links Disclaimer</h1>
          <p>
          ...
          <h1 class="text-2xl">Errors and Omissions Disclaimer</h1>
          <p>
          ...
          <h1 class="text-2xl">Fair Use Disclaimer</h1>
          <p>
          ...
          <h1 class="text-2xl">Views Expressed Disclaimer</h1>
          <p>
          ...
          <h1 class="text-2xl">No Responsibility Disclaimer</h1>
          <p>
          ...
          <h1 class="text-2xl">&quot;Use at Your Own Risk&quot; Disclaimer</h1>
          <p>
          ...
          <ul>
            <li>By email: skullandbonesdao@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
